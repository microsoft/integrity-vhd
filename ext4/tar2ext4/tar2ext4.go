...
import (
	...
	"github.com/Microsoft/integrity-vhd/ext4/internal/compactext4"
	"github.com/Microsoft/integrity-vhd/ext4/internal/format"
...
func IsDeviceExt4(devicePath string) bool {
	...
	if err != nil {
		log.Warnf("failed to read Ext4 superblock: %s", err)
	}
	return err == nil
}
